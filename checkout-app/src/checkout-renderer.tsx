...
import { Check, ShieldCheck, Star, Lock, Clock, Loader2, Copy, Check as CheckIcon } from "lucide-react";

/** Mídias salvas no editor ficam em /api/public/media/... no backend VorksPay.
 *  Em domínios de checkout próprios esse caminho é relativo ao SPA, então
 *  precisamos prefixar com a base da API para a imagem carregar. */
const mediaSrc = (u?: string | null) =>
  u && u.startsWith("/api/") ? api(u) : (u ?? "");
